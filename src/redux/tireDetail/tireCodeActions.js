...
import { TIRECODE_READING_REQUEST, TIRECODE_READING_SUCCESS, TIRECODE_READING_FAIL, RESET_TIRE_DETAIL } from './tireCodeConstans'

const tireCodeDetail = (tireCode) => async (dispatch) => {
     try {
...
export { tireCodeDetail,resetTireDetails}